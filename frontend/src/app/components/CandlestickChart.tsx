...
const CandlestickChart: React.FC<PriceChartProps> = ({ data, signals }) => {
  ...
  useLayoutEffect(() => {
    ...
    try {
      ...
      const chart = createChart(chartContainerRef.current, {
        layout: {
          background: { type: ColorType.Solid, color: "#171835" },
        ...
        height: 300,
        grid: {
          vertLines: { visible: true, color: "#38305F" },
          horzLines: { color: "#38305F" },
        },
        rightPriceScale: {
          borderVisible: false,
        },
...
export default dynamic(() => Promise.resolve(CandlestickChart), {
  ...
  loading: () => (
    <div className="w-full">
      ...
      <div className="h-[300px] flex items-center justify-center text-dark-200">
        Loading...
      </div>
    </div>
  ),
